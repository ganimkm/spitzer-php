                ...
                <tbody>
                    <tr>
                        <td width="52" style="padding-right:12px;">
                            <img width="42" height="42" style="margin-top: 5px; margin-bottom: 5px;" src="<?php echo base_url() . '/assets/img/printer.png' ?>" alt="" hspace="14" vspace="2">
                        </td>
                        <td>
           ...
           <div class="col-md-12 pr-0">
               ...
               <div class="main-tab">
                ...
                <ul class="nav nav-pills" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="#summary" id="summary-tab" role="tab" data-toggle="tab" aria-controls="summary" aria-expanded="true"><img class="main-tab-img" src="<?php echo base_url() . '/assets/img/printer.png' ?>">Summary</a>
                    </li>
                                            ...
                                            <div class="asset-summary">
                                                <table border="0" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>Asset type:</td>
                                                            <td><img class="device-img" src="<?php echo base_url() . '/assets/img/printer.png' ?>"></td>
