        ...
        foreach ($printer in $printers) {
            ...
            if ($result.Status -eq 'Success') {
                ...
                if ($model) {
                    ...
                    try { $sn = $snmp.Get('.1.3.6.1.2.1.43.5.1.1.17.1') } catch { $sn = $null } 
                    ...
                    switch -Regex ($model) {
                        ...
                        '^lexmark' {
                            ...
                            try { $sn = $snmp.Get('.1.3.6.1.4.1.641.2.1.2.1.6.1') } catch { $sn = $null } 
                        }
                        '^ricoh' {
...
Get-SNMPPrinterInfo("172.20.2.143","172.20.2.159","172.20.3.66","172.20.4.129") 